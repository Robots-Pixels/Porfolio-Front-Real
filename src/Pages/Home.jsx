...
import { FaEnvelope, FaGithub, FaLinkedin, FaDotCircle, FaArrowRight, FaEye, FaWhatsapp } from 'react-icons/fa';
    ...
    style={{transition: "all 0.5s ease", transform: `translateY(${transform}rem)`}}>
        ...
        <section id="about" className="py-20 bg-[#d5fadd]">
            <div className="max-w-3xl md:max-w-6xl mx-auto px-6 md:px-8]">
                ...
                <span className='text-3xl'>I</span>'m Otmar — your partner in building powerful, scalable, and user-focused web applications. As a professional web developer with over 2 years of experience, I help businesses and entrepreneurs turn their ideas into robust digital solutions. Using top level technologies, like the MERN stack, I craft clean, efficient code and seamless user experiences — always with scalability and performance in mind. If you need a website or web app that’s fast, reliable, and designed for growth, let’s make it happen.</p>
                <p className="mt-4 text-md sm:text-lg">
                <span className='text-3xl'>C</span>uriosity and continuous learning fuel my craft. I stay ahead in the fast-moving tech world, constantly exploring new tools and technologies — <span className='font-bold'> so I can deliver innovative, future-proof solutions for my clients</span></p>
                <p className="mt-4 text-md sm:text-lg">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div onClick={(e) => {e.stopPropagation(); window.location.href='https://celeste-restaurant.vercel.app/'}} className="relative project overflow-hidden group">
                        ...
                        style={{transition: "translate 0.7s"}}>
                            ...
                            <div>
                                <h3 className='text-[#faf8ff] w-[20rem] sm:w-[30rem] text-center font-bold'>
                            ...
                            <div className='flex items-center justify-center text-2xl gap-10'>
                                ...
                                <Link className='text-2xl sm:text-4xl text-black' to={"https://github.com/Robots-Pixels/Celeste-Restaurant"} target='_blank'>
                                    <button className='flex items-center bg-[#028041] rounded-sm gap-2 p-1 text-[#faf8ff]'>
                                        <span className='text-sm sm:text-xl'>Code Here</span>
                                        <FaGithub className='text-[1rem] sm:text-[2rem]'/>
                                    </button>
                                </Link>

                                <Link className='text-2xl sm:text-4xl text-black' to={"https://github.com/Robots-Pixels/Celeste-Restaurant"} target='_blank'>
                                    <button className='flex items-center bg-[#028041] rounded-sm gap-2 p-1 text-[#faf8ff]'>
                                        <span className='text-sm sm:text-xl'>Live Preview</span>
                                        <FaEye className='text-[1rem] sm:text-[2rem]'/>
                                    </button>
                                </Link>
                    ...
                    <div onClick={(e) => {e.stopPropagation(); window.location.href='https://yumking-frontend.vercel.app/'}} className="relative project overflow-hidden group">
                        ...
                        style={{transition: "translate 0.7s"}}>
                            ...
                            <div className='flex items-center justify-center text-2xl gap-10'>
                                ...
                                <Link className='text-2xl sm:text-4xl text-black' to={"https://github.com/Robots-Pixels/yumking-fast-food-app"} target='_blank'>
                                    <button className='flex items-center bg-[#028041] rounded-sm gap-2 p-1 text-[#faf8ff]'>
                                        <span className='text-sm sm:text-xl'>Code Here</span>
                                        <FaGithub className='text-[1rem] sm:text-[2rem]'/>
                                    </button>
                                ...
                                <Link className='text-2xl sm:text-4xl text-black' to={"https://yumking-frontend.vercel.app/"} target='_blank'>
                                    <button className='flex items-center bg-[#028041] rounded-sm gap-2 p-1 text-[#faf8ff]'>
                                        <span className='text-sm sm:text-xl'>Live Preview</span>
                                        <FaEye className='text-[1rem] sm:text-[2rem]'/>
                                    </button>
