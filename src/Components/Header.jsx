                ...
                <div className='max-w-3xl md:max-w-6xl mx-auto px-6 md:px-8 h-full'>
                    ...
                    <div className={`flex flex-col gap-3 text-[#052935] h-full justify-center`}>
                        ...
                        <div className='mt-2 -ml-1'>
                            <HashLink smooth to={"#contact"} className='border-[#028041] border-1 text-[#028041] px-5 py-2 text-[1rem] rounded-xl shadow-3xs shadow-[#028041] hover:bg-[#028041] hover:text-[#fff] transition-colors'>
                                Contact Me
                            </HashLink>
                        </div>
